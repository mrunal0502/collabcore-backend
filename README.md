...
## CollabCore API Backend

### 1. Product Overview

**Product Name:** CollabCore API Backend  
**Version:** 1.0.0  
**Product Type:** Backend API for Project Management System

CollabCore API Backend is a RESTful API service designed to support collaborative project management. The system enables teams to organize projects, manage tasks with subtasks, maintain project notes, and handle user authentication with role-based access control.
...
- `POST /chahnge-password` - Change user password (secured)
